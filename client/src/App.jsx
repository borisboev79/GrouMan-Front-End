  ...
  return (
    <div>
        ...
        <div className="inner">
          ...
          <figure>
            <blockquote>
              ...
              euismod in, pharetra
              <br /> magna etiam lorem ultricies in diam. Sed arcu cras
              consequat."
            </blockquote>
            <footer>
      ...
      <section id="main" className="wrapper"><div className="inner">
            ...
            </header>{/* Content */}<h2 id="content">Sample Content</h2>
            ...
            <hr className="major" />{/* Elements */}<h2 id="elements">Elements</h2>
            <div className="row 200%">
              <div className="12u">
                ...
                <ul className="actions"><li><a href="#" className="button special">Default</a></li>
                  ...
                  <div className="3u 12u$(small)">
                    <ul className="actions vertical"><li><a href="#" className="button special">Default</a></li>
                      <li><a href="#" className="button">Default</a></li>
                      <li><a href="#" className="button alt">Default</a></li>
                    </ul></div>
                  <div className="3u 12u$(small)">
                  ...
                  <div className="3u 12u$(small)">
                    <ul className="actions vertical"><li><a href="#" className="button special fit">Default</a></li>
              ...
              <div className="12u">
                ...
                <ul className="actions"><li><a href="#" className="button special">Special</a></li>
                  ...
                  <li><a href="#" className="button">Default</a></li>
                  <li><a href="#" className="button alt small">Small</a></li>
                </ul><ul className="actions fit"><li><a href="#" className="button special fit">Fit</a></li>
                  <li><a href="#" className="button fit">Fit</a></li>
                  <li><a href="#" className="button alt fit">Fit</a></li>
                </ul><ul className="actions fit small"><li><a href="#" className="button special fit small">Fit + Small</a></li>
                  <li><a href="#" className="button fit small">Fit + Small</a></li>
                  <li><a href="#" className="button alt fit small">Fit + Small</a></li>
                </ul><ul className="actions"><li><a href="#" className="button special icon fa-search">Icon</a></li>
                ...
                <form method="post" action="#">
                  <div className="row uniform">
                    <div className="6u 12u$(xsmall)">
                      <input type="text" name="name" id="name" defaultValue placeholder="Name" /><div data-lastpass-icon-root="true" style={{position: 'relative !important', height: '0px !important', width: '0px !important', float: 'left !important'}} /></div>
                    <div className="6u$ 12u$(xsmall)">
                      <input type="email" name="email" id="email" defaultValue placeholder="Email" /></div>
                    {/* Break */}
                    <div className="12u$">
                    ...
                    <div className="4u 12u$(small)">
                      <input type="radio" id="priority-low" name="priority" defaultChecked /><label htmlFor="priority-low">Low Priority</label>
                    </div>
                    <div className="4u 12u$(small)">
                    ...
                    <div className="6u$ 12u$(small)">
                      <input type="checkbox" id="human" name="human" defaultChecked /><label htmlFor="human">I am a human and not a robot</label>
                    </div>
                    {/* Break */}
                    <div className="12u$">
                      <textarea name="message" id="message" placeholder="Enter your message" rows={6} data-gramm="false" wt-ignore-input="true" defaultValue={""} /></div>
                    {/* Break */}
                    <div className="12u$">
                      <ul className="actions"><li><input type="submit" defaultValue="Send Message" /></li>
                ...
                <hr /><form method="post" action="#">
                  <div className="row uniform">
                    <div className="9u 12u$(small)">
                      <input type="text" name="query" id="query" defaultValue placeholder="Query" /></div>
                    <div className="3u$ 12u$(small)">
                      <input type="submit" defaultValue="Search" className="fit" /></div>
                  </div>
                </form>
                {/* Image */}
                <h3>Image</h3>
                <h4>Fit</h4>
                <span className="image fit"><img src="images/pic02.jpg" alt="" width={418} height={200} /></span>
                <div className="box alt">
                  <div className="row 50% uniform">
                    <div className="4u"><span className="image fit"><img src="images/pic01.jpg" alt="" width={330} height={330} /></span></div>
                    <div className="4u"><span className="image fit"><img src="images/pic01.jpg" alt="" width={330} height={330} /></span></div>
                    <div className="4u$"><span className="image fit"><img src="images/pic01.jpg" alt="" width={330} height={330} /></span></div>
                    {/* Break */}
                    <div className="4u"><span className="image fit"><img src="images/pic01.jpg" alt="" width={330} height={330} /></span></div>
        ...
        </section>{/* Footer */}<footer id="footer"><div className="inner">
            <h2>Get In Touch</h2>
            <ul className="actions"><li><span className="icon fa-phone" /> <a href="#">(000) 000-0000</a></li>
              <li><span className="icon fa-envelope" /> <a href="#">information@untitled.tld</a></li>
              <li><span className="icon fa-map-marker" /> 123 Somewhere Road, Nashville, TN 00000</li>
            </ul></div>
